...
urlpatterns = [
    ...
    path('blogapi/memento_create/', blogapi.views.memento_create, name='add_memento'),
    path('blogapi/memento_create/<int:id_item>', blogapi.views.memento_create, name='add_memento'),
    ...
    path('blogapi/p13/', blogapi.views.display_project_13, name='p13'),
    path('blogapi/p14/', blogapi.views.display_project_14, name='p14'),
    path('blogapi/p15/', blogapi.views.display_project_15, name='p15'),
    path('blogapi/p16/', blogapi.views.display_project_16, name='p16'),
    path('blogapi/p17/', blogapi.views.display_project_17, name='p17'),
    path('blogapi/p18/', blogapi.views.display_project_18, name='p18'),
    path('blogapi/contacts/', blogapi.views.display_contacts, name='contacts'),
    path('blogapi/favoris/', blogapi.views.display_favoris, name='favoris'),
    path('blogapi/params/', blogapi.views.display_params, name='params'),
